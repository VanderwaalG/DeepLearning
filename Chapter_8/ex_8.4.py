...
class Bert_Model(nn.Module):
    def __init__(self):
        ...
        self.model = BertModel.from_pretrained('bert-base-chinese',cache_dir="./Bert_model").to(device)
...
print('正确分类的样本数：{}，样本总数：{}，准确率：{:.2f}%'.format(correct, len(test_loader.dataset),
