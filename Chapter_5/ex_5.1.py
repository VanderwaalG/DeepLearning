...
for i,param in enumerate(cat_dog_vgg16.parameters()):  # 【此处为本例核心代码，已省略，完整代码见教材P120；建议读者手工输入核心代码并进行调试，这样方能领会其含义】
...
for epoch in range(10): #执行10代
    ...
    for i,(x,y) in enumerate(train_loader):
        ...
        loss = nn.CrossEntropyLoss()(pre_y, y.long())  # 使用交叉熵损失函数  PyTorch 的 CrossEntropyLoss 默认使用 reduction='mean'，这意味着它计算的是当前批次所有样本损失的平均值
