...
class UNet(nn.Module):
    def __init__(self, n1, n2):
        ...
        # 【此处为本例部分核心代码，已省略，完整代码见教材P155；建议读者手工输入核心代码并进行调试，这样方能领会其含义】
...
torch.save(unet_model,'unet_model')
'''
exit(0)
'''
#------------------------------------------------------
def showTwoimgs(imgs, stitle='', rows=1, cols=2):
    ...
    plt.show()
unet_model = torch.load('unet_model')  # unet_model10 是没有被覆盖的
unet_model.eval()
...
'''
64 0.7869182229042053
65 0.8394394516944885
准确率为： 37534540.0/40089600 = 93.63%
指标Dice score的值为: 0.83
